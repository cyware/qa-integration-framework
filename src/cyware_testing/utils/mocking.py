...
from cyware_testing.constants.paths.sockets import QUEUE_DB_PATH
from cyware_testing.utils import client_keys, file, services
from cyware_testing.utils.db_queries import global_db, agent_db
...
def create_mocked_agent(name='centos8-agent', ip='127.0.0.1', register_ip='127.0.0.1', internal_key='',
                        ...
                        os_uname='x64', os_arch='x64', version='Cyware v4.3.0', config_sum='', merged_sum='',
    ...
    # Restart Cyware-DB before creating new DB
