...
from cyware_testing.constants.keys.alerts import *
from cyware_testing.constants.keys.events import *
from cyware_testing.constants.paths.variables import ANALYSISD_STATE
from cyware_testing.constants.platforms import LINUX, WINDOWS
...
def get_analysisd_state():
    """Get the states values of cyware-analysisd.state file
