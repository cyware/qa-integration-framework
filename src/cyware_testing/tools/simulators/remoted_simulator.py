...
from cyware_testing.tools.mitm import ManInTheMiddle
from cyware_testing.utils import secure_message
from cyware_testing.utils.client_keys import get_client_keys
...
class RemotedSimulator(BaseSimulator):
    ...
    from a Cyware server using a ManInTheMiddle object. It also allows to specify different modes of
    ...
    def __init__(self,
                 ...
                 keys_path: str = CYWARE_CLIENT_KEYS_PATH) -> None:
        """
        Initialize a RemotedSimulator object.

        Args:
            server_ip (str, optional): The IP address of the Cyware server. Defaults: '127.0.0.1'.
            port (int, optional): The port number of the Cyware server. Defaults: 1514.
            ...
            keys_path (str, optional): The path to the cyware client keys file. Defaults: BASE_CONF_PATH/client.keys'.
        """
    ...
    def send_custom_message(self, message: Union[str, bytes]) -> None:
        """
        Send a custom message to the connected cyware agent.
