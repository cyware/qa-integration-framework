...
from cyware_testing.utils.database import query_wdb
from cyware_testing.utils.decorators import retry
from cyware_testing.utils.network import TCP, is_udp, is_tcp
from cyware_testing.utils.random import get_random_ip, get_random_string
...
class Agent:
    ...
    Args:
        ...
        version (str, optional): Cyware agent version. Default v3.12.0.
        labels (dict, optional): Cyware agent labels. Each dict key will be a new label.
    ...
    def process_command(self, sender, message_list):
        ...
        if 'com' in message_list:
            ...
            ['12d95abf04334f90f8dc3140031b3e7b342680000000130:5489:#!-req', '81d15486', 'com', 'close',
                'cyware_agent_v4.2.0_linux_x86_64.wpk']
            ...
            ['8c0e7a8d75fea76016040ce436f9fb41193290000000130:5491:#!-req', '81d15488', 'com', 'upgrade',
                'cyware_agent_v4.2.0_linux_x86_64.wpk', 'upgrade.sh']
            """
